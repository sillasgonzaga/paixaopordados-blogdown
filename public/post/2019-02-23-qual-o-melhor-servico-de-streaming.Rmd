...
O comportamento da função `just_watch.search_for_item()`  é o mesmo de você pesquisar manualmente no site. Isto é, ao digitar na caixa de busca o título que você, aparecerá uma lista com os resultados relacionados, mas provavelmente o primeiro resultado é o que interessa. Por isso, no código abaixo, eu extraio o primeiro resultado da busca. Funciona na maioria das vezes.
